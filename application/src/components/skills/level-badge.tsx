...
const LEVEL_STYLES: Record<string, string> = {
  XS: 'bg-slate-500/15 text-slate-300 border-slate-500/30',
  S: 'bg-sky-500/15 text-sky-300 border-sky-500/30',
  M: 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30',
  L: 'bg-violet-500/15 text-violet-300 border-violet-500/30',
};
